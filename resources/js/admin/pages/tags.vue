						...
						<table class="_table">
							...
							<tr v-for="(tag, i) in tags" :key="i" v-if="tags.length">
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeletingModal(tag,i)" :loading="tag.isDeleting" v-if="isUpdatePermitted">Delete</Button>
...
export default {
	...
	methods: {
		async addTag() {
			if(this.data.tagName.trim()=='') return this.e('Tage name is required!')
		...
		async editTag() {
			if(this.editData.tagName.trim()=='') return this.e('Tage name is required!')
